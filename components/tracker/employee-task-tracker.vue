...
import Vite from '../../components/icons/ViteIcon.vue'
import Vue from '../../components/icons/Vue.vue'
import AnimatedBeam from '../spark-ui/AnimatedBeam.vue'
import Circle from '../spark-ui/Circle.vue'
...
<template>
  <div class="grid place-items-center min-h-screen w-full">
    <div
      ref="containerRef"
      class="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg  bg-background p-10 md:shadow-xl"
    >
